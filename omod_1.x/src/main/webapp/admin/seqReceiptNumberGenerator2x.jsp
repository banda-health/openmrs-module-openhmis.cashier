...
<openmrs:require privilege="Manage Cashier Bills" otherwise="/login.htm" redirect="/module/openhmis/cashier/admin/seqReceiptNumberGenerator2x.page" />
        ...
        <div>
            ...
            <ul>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <label class="removeBold" for="groupingType_CASHIER_AND_CASH_POINT">
                                        <spring:message code="openhmis.cashier.receiptGenerator.groupByCashierCashPoint" />
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="indent" style="font-style: italic;">
                                    <spring:message code="openhmis.cashier.receiptGenerator.eachCashierCashPointSequence" />
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <li class="bbf-field field-description">
                    ...
                    <div class="bbf-editor">
                        <input id="cashierPrefix" name="cashierPrefix" type="text" value="${generator.cashierPrefix}" class="form-control">
                    </div>
                </li>
                <li class="bbf-field field-description">
                    ...
                    <div class="bbf-editor">
                        <input id="cashPointPrefix" name="cashPointPrefix" type="text" value="${generator.cashPointPrefix}" class="form-control">
                    </div>
                </li>
                <li class="bbf-field field-description">
                    ...
                    <div class="bbf-editor">
                        <input id="sequencePadding" name="sequencePadding" type="number" value="${generator.sequencePadding}" class="form-control">
                    </div>
                </li>
                <li class="bbf-field field-description">
