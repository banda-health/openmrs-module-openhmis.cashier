...
<%--
  ...
  --%>
<openmrs:require allPrivileges="<%=CashierPrivilegeConstants.MANAGE_METADATA %>, <%=CashierPrivilegeConstants.VIEW_METADATA %>" otherwise="/login.htm" redirect="/module/openhmis/cashier/cashPoints.form" />
