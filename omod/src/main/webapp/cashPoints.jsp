...
<script type="text/javascript" src="/openmrs/moduleResources/openhmis/cashier/js/model/cashPoint.js"></script>
<script type="text/javascript">
$(function() {
	openhmis.startAddEditScreen(openhmis.CashPoint, "/cashPoint", {
