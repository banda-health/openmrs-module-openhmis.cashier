...
(function() {
    ...
    /* Define model fields */
    function PaymentModeModel(GenericMetadataModel) {
        ...
        extended.getModelFields = function() {
            var fields = ["description", "sortOrder", "attributeTypes"];
    ...
    baseModel.factory("PaymentModeModel", PaymentModeModel);

    PaymentModeModel.$inject = ['GenericMetadataModel'];
